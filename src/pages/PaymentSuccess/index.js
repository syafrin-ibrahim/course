    ...
    return (
        <View style={styles.page}>
            <View style={styles.body}>
                ...
                <Text style={styles.transfer}>Payment Complete</Text>
                <Gap height={23}/>
                ...
                <View style={styles.textbox}>
                    ...
                    <Gap height={17}/>
                    <Text style={styles.info}>Merchant : Basic School</Text>
                    <Gap height={12}/>
                    <Text style={styles.info}>Jl Ciparay No 20B, Kota Bandung</Text>
                </View>
                <Gap height={21}/>
